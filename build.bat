...
REM RUN JPACKAGE
jpackage --input "out\artifacts\Five_Nights_At_iACADEMY_jar" --main-jar "Five-Nights-At-iACADEMY.jar" --main-class main.Main --name "NightsAtIAcademy" --app-version 1.0 --type app-image --runtime-image "C:\Program Files\Java\jdk-25" --icon "res\icons\icon.ico" --java-options "--module-path $APPDIR/lib --add-modules javafx.media,javafx.swing,javafx.base,javafx.graphics,javafx.controls --enable-native-access=ALL-UNNAMED"
